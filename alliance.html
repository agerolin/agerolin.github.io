...
<header id="header">
	<div id="head" class="parallax" parallax-speed="1">
		<h1 id="logo" class="text-center">
			<img class="img-circle" src="assets/images/topindex.jpg" alt="">
  ...
  <div class="container">
		...
		<div class="row topspace">
			...
			<article class="col-sm-14 maincontent">
				<h3>Quantum Optimal Transport</h3>
						<p class="subtitle">at the interface of Quantum Information, Quantum Chemistry and Quantum Machine Learning</p>
<p><img src="assets/images/uottawaredlogo.png" alt="" width="135" height="135" align="center"> <img src="assets/images/mcmaster.jpeg" alt="" width="174" height="102"/><img src="assets/images/unb.png"  alt="" width="174" height="172"/><img src="assets/images/queens.png" alt="" width="165" height="129"/><img src="assets/images/dalhousie-logo.png" alt=""/><img src="assets/images/sfulogo.png" alt=""/>
...
Our research lies at the boundary between mathematics, quantum physics, quantum information theory, electronic structure theory, machine-learning,
and software design/deployment. Transcending boundaries between fields, in particular the physical, mathematical and computational aspects of quantum, is key for the
development of scalable, rigorous and efficient algorithms.
 </p>  
	
					
							<p>This project receives funding from the National Research Council of Canada and Alliance Society.</p>
                ...
                <div class="row">
					<div class="col-lg-3">
                      <div class="team-member">
                        ...
                        <h4>Paul Ayers</h4>
                        <p class="text-muted">McMaster<br>
                          Chemistry &amp; Algorithms</p>
                      </div>
                    </div>
                    <div class="col-lg-3">
                      <div class="team-member">
                          <img class="mx-auto rounded-circle" src="assets/images/team/stijn.png" alt="..." />
                          <h5>Stijn De Baerdemacker</h5>
                          <p class="text-muted">UNB<br> 
					...
					<div class="col-lg-3">
                        <div class="team-member">
							...
							<img class="mx-auto rounded-circle" src="assets/images/team/stefanie.jpg" alt="..." />
                            <h4>Stefanie Czischek</h4>
                            <p class="text-muted">uOttawa<br> 
                    ...
                    <div class="timeline-image">
                        ...
                        <div class="col-lg-3">
                            <div class="team-member">
                            <div class="timeline-image">
                            <img class="mx-auto rounded-circle" src="assets/images/team/khabat.jpg" alt="..." />
                            <h4>Khabat Heshami</h4>
                          <p class="text-muted">uOttawa and NRC<br>
 Quantum Physics </p>
                        </div>
                        </div>
                    </div> 
                    ...
                    <div class="col-lg-3">
                            <div class="team-member">
                            <div class="timeline-image">
                            <img class="mx-auto rounded-circle" src="assets/images/team/kero.jpg" alt="..." />
                            <h4>Kero Lau</h4>
                          <p class="text-muted">SFU<br>
Quantum Information </p>
                    ...
                    <div class="col-lg-3">
                        <div class="team-member">
							<img class="mx-auto rounded-circle" src="assets/images/team/ryan.jpg" alt="..." />
                            <h4>Ryan MacDonell</h4>
                            <p class="text-muted">Dalhousie<br>
                          Quantum Chemistry</p>
						</div>
                        </div>
...
<div class="col-lg-3">
                   ...
                   <div class="col-lg-3">
                      <div class="team-member">
                          ...
                          <h4>David Kribs</h4>
                          <p class="text-muted">Guelph, Collaborator<br> 
                          Quantum Information</p>
                      </div>
                  </div>
                <!--    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="team-member">
							<img class="mx-auto rounded-circle" src="assets/images/team/adil.jpg" alt="..." />
                            <h4>Adil Salim</h4>
                            <p class="text-muted">Microsoft (USA), Collaborator<br>
                          Machine Learning</p>
						</div>
                        </div>
...
<header class="page-header">
 ...
 <p>We are looking for talented candidates to join our research team, including: <br><br>
	 ...
	 -- One <font color="#2c0070"> PhD student in Mathematics (Ottawa)</font>: potential candidates are expected to have experience or interest in conducting research on Calculus of Variations, Optimization, Mathematical Physics, Scientific Computing, Numerical Linear Algebra and/or Optimal Transport.<br>
<br>

	 -- One <font color="#2c0070">PhD student in Physics, Chemistry and/or Engineering (Ottawa, McMaster, Queen's, New Brunswick)</font>: potential candidates must have a strong background in quantum mechanics, quantum information, quantum optics and/or scientific computing. She/he should be motivated to learn state-of-art methods in quantum optimal transport.<br><br>

	 -- One <font color="#2c0070">Postdoctoral Researcher in Mathematics, Quantum Physics or Chemistry (all)</font>: potential candidates are expected hold a PhD in Physics, Chemistry, Mathematics or Computer Sciences, have interest in developing theory and/or algorithms.  <br><br>

				
 Candidates are invited to apply by email via the address <a href="mailto:CRCAIMathChe@uottawa.ca">CRCAIMathChe@uottawa.ca</a> with copy to <a href="mailto:eelkhour@uottawa.ca">Elitta El Khouri</a>   subject<b> “PhD Math QOT 2025”</b>, <b> “PhD PhyChm QOT 2025”</b> or <b>“Postdoc QOT 2025”</b>. The application package should include the following documents as attachment in a single pdf file:<br>
					 <br>
					 1) Cover Letter;<br>
					 ...
					 3) Postdoc position:<b> Research statement</b> on current and planned research (max 5 pages);<br>
	 				 3') PhD position: <b>Transcript of records</b> and a brief (e.g., one paragraph) description of research interest;<br>
					 4) <b>A list of at most three referees</b> who are willing to write a letter of recommendation.<br><br> 
						
					 Selected candidates will be requested to have their referees send a letter of recommendation directly to the search committee, and will be invited for an online interview. Applications will be evaluated starting from <b>May 1st</b>. The positions will remain open until the appropriate candidate is hired.<br><br>
					
					While in Canada, the young researchers will perform a highly collaborative and interdisciplinary research. There is also the possibility to take part of the <a href="http://www.fields.utoronto.ca/activities/26-27/optimal" target_"blank">Thematic Program on Optimal Transport in Natural Sciences and Statistics</a> that take place from July 1 to December 31, 2026 at the Fields Institute of Mathematical Sciences.<br><br>

                        We are committed to fostering a diverse inclusive, and equitable research environment, welcoming applicants from all backgrounds. We believe that diversity enhances creativity and innovation, and we aim to provide an environment where everyone can thrive and contribute to groundbreaking and impactful research.<br><br>
 
 As part of our team, you will receive competitive benefits, including access to cutting-edge resources, collaboration opportunities with leading experts in the field and professional development support. You will also be part of a vibrant academic community, with networking events, workshops and travel funding to attend international conferences, broadening your exposure and supporting your academic and professional growth.<br><br>
