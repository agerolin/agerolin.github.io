...
<header id="header">
	<div id="head" class="parallax" parallax-speed="1">
		<h1 id="logo" class="text-center">
			...
			<span class="tagline">Postdoctoral Researcher, University of Jyväskylä</span>
		</h1>
	</div>
...
<?php      
    ...
    $data = file_get_contents ('http://cvgmt.sns.it/api/papers/?authors__firstname=&authors__id=&authors__lastname=Gerolin&authors__user__username=&format=json&keywords__name=&tags__value=&title=&year=');
	...
	$i =0;
	echo "We warmly thank the <a href=http://cvgmt.sns.it/credits/ target=_blank>CVGMT Team</a> for the support and for hosting the following papers at <a href=http://cvgmt.sns.it/ target=_blank>CVGMT</a> server.<br><br>";
	...
	echo "<font color='#2c0070'><b>[" . $num . "]</b>&nbsp;" . $title . " (" . $year . ")</font><br> <i>(";
	...
	echo "" . $journal . " <a href=http://cvgmt.sns.it/paper/" . $json['results'][$i]['id'] . "/ target='_blank'> <i class='fa fa-external-link-square'></i></a> <br><br>";
