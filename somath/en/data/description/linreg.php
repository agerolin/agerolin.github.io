...
<div class="content">
			<div class="single">
				<div class="single-top">
					...
					<h2>Linear Regression <div style="float:right;"><a href="#finnish"><img src="../../../images/iconinfinnish"  alt=""/></a></div></h2><br>
					<p class="para">    <p>This is a preliminary (testing) pages used for a course. This webpage is not fully working. <br><br> Linear regression is perhaps one of the most well known and well understood algorithms in machine learning and statistics. Learning a (simple) linear regression model means estimating the values of the coefficients of an affine function (a line!)<br> </p><br>
    
     <div align="center"> $f(x) = ax + b, \quad a,b\in \mathbb{R}.$</div><br><p> 
...
<h3> How it works? </h3>
   ...
   However, obtain an analytical solution for our model is very rare in statistics and machine learning. We often needs to design algorthms to compute numerically the solution of our model. For example, if instead of find the best line we are interested in finding best polynomial of degree 3 approximating our data points, no analytical solutions are available.<br>
              ...
              <br>
                  ...
                  <div align="center">$ Y = \beta X + \beta_0, \quad Y,\beta_0\in\mathbb{R}^N, X\in\mathbb{R}^p $ </div> 
                   <p><br> Now we are dealing with vectors and then we aim to <i>"learn"</i> the coeficients of the Nxp matrix </p>$\beta$.	<br>
