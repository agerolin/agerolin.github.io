		...
		<div class="header-left">
			...
			<div class="top-nav">
				<ul >
                  ...
                  ?>  
				    <?php if($link == "activities") {
						echo"<li class='active'>"; }
						else { echo "<li>"; } 
					?>      
                    <a href="index.php?l=activities">ACTIVITIES</a></li>
                  
				   <?php if($link == "school") {
						echo"<li class='active'>"; }
						else { echo "<li>"; } 
					?>
                    <a href="index.php?l=school" class="black2" >  FOR SCHOOLS</a></li>
					
                   <?php if($link == "about") {
						echo"<li class='active'>"; }
						else { echo "<li>"; } 
					?>
                    <a href="index.php?l=about" class="black3" > ABOUT</a></li>
					<?php if($link == "contact") {
						echo"<li class='active'>"; }
						else { echo "<li>"; } 
					?>
                   
                    <a href="index.php?l=contact" class="black4" > CONTACT US</a></li>
				</ul>
			</div>
			<ul class="social-in">
